    ...
    const propertyData = [
        {
            ...
            plotNumber: '#1234',
            location: 'Bhur, Gelephu',
            registryNumber: 'LR20225001',
            area: '1.2 Acres',
            verified: true,
        },
        {
        ...
        switch (activePopup) {
                                    ...
                                    >
                                        <div>
                                            <h3 className="text-md font-semibold text-gray-800">
                                                {property.type} - Plot {property.plotNumber}
                                            </h3>
            ...
            case 'sale':
                return (
                    <div>
                        <div className="bg-white ">
                            <h2 className="text-lg font-semibold mb-4">Listed For Sale</h2>
                            <ul className="space-y-3">
                                {propertyData.map((property, index) => (
                                    <li
                                        key={index}
            ...
            <div className="flex-grow p-4 sm:p-8 pt-16">
                        ...
                        <div className="relative bg-white p-4 sm:p-6 rounded-xl shadow-2xl w-full max-w-4xl sm:w-11/12 md:w-10/12 lg:w-2/3 xl:w-1/2 max-h-[95vh] min-w-[60vw] overflow-y-auto">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6">
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg shadow">
                                    <h3 className="text-md sm:text-md font-semibold  mb-3 text-[#142854]">Transaction Overview</h3>
                                    <div className="space-y-2 text-sm sm:text-base">
                                        ...
                                        <p>
                                            ...
                                            <span
                                                className={`
                                                    ${selectedTransaction?.status === 'Pending' ? 'text-orange-500' : ''}
                                                    ${selectedTransaction?.status === 'Rejected' ? 'text-red-500' : ''}
                                                    ${selectedTransaction?.status === 'approved' ? 'text-green-500' : ''}
                                ...
                                {/* Document Section */}
                                <div className="bg-gray-50 p-4 rounded-lg shadow">
                                    <h4 className="text-md sm:text-md font-semibold text-gray-800 mb-3 text-[#142854]">Document Attached</h4>
                                    <div className="text-sm sm:text-base">
                                        {selectedTransaction?.documentUrl ? (
                                            <div className="">
                                                <div className="bg-gray-100 rounded-lg rounded p-2 border">
                                                    <a
                                                ...
                                                <div className="bg-gray-100 rounded-lg rounded p-2 border mt-2">
                                                    <a
                                                        href={selectedTransaction.documentUrl}
                                                        download
                                                        className="flex justify-between items-center w-full gap-2 text-gray-700 no-underline hover:text-gray-900"
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg shadow">
                                    ...
                                    <div className="pb-3">
                                        <div className="space-y-2">
                                            ...
                                            <p>Email: {selectedTransaction?.buyerInfo?.email || "N/A"}</p>
                                            <p>CID: {selectedTransaction?.buyerInfo?.id || "N/A"}</p>
                                            <p>Contact: {selectedTransaction?.buyerInfo?.number || "N/A"}</p>
                                        </div>
                                    </div>
                                    <hr />
                                    <div className="pt-3">
                                        <div className="space-y-2">
                                            <h4 className="font-semibold text-gray-800 text-[#142854]">Seller Details</h4>
                                            <p>Name: {selectedTransaction?.sellerInfo?.name || "N/A"}</p>
                                            <p>Email: {selectedTransaction?.sellerInfo?.email || "N/A"}</p>
                                            <p>CID: {selectedTransaction?.sellerInfo?.id || "N/A"}</p>
                                            <p>Contact: {selectedTransaction?.sellerInfo?.number || "N/A"}</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-gray-50 p-4 rounded-lg shadow text-sm sm:text-base">
                                    <h3 className="font-semibold text-bold text-[#142854]">Land Information</h3>
                                    <div className="space-y-2">
                                        <p>Location: {selectedTransaction?.landInfo?.location || "N/A"}</p>
                                        <p>Size:{selectedTransaction?.landInfo?.size || "N/A"}</p>
                                        <p>Plot Number: {selectedTransaction?.landInfo?.plotnumbr || "N/A"}</p>
                                        <p>Land Type: {selectedTransaction?.landInfo?.type || "N/A"}</p>
                                        <p>Coordinates: {selectedTransaction?.landInfo?.coordinates || "N/A"}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-8">
                    <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 relative ">
                        <h2 className="col-span-full text-xl font-semibold text-gray-800 mb-4">Status Overview</h2>
                        <a onClick={() => handleOpenPopup('properties')} className="cursor-pointer group relative bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 h-28 grid grid-cols-2 items-center p-4">
                            ...
                            <div className="relative z-10 flex flex-col justify-center items-start">
                                <h3 className="text-sm font-medium text-blue-700 group-hover:text-white transition-colors duration-300">My Properties</h3>
                                <p className="text-lg font-semibold text-blue-800 group-hover:text-white transition-colors duration-300">8 plots</p>
                            </div>
                        </a>
                        <a onClick={() => handleOpenPopup('pending')} className="cursor-pointer group relative bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 h-28 grid grid-cols-2 items-center p-4">
                            ...
                            <div className="relative z-10 flex flex-col justify-center items-start">
                                <h3 className="text-sm font-medium text-green-700 group-hover:text-white transition-colors duration-300">Pending Transactions</h3>
                                <p className="text-lg font-semibold text-green-800 group-hover:text-white transition-colors duration-300">3</p>
                            </div>
                        </a>

                        {/* Card: Ongoing Disputes */}
                        <a onClick={() => handleOpenPopup('disputes')} className="cursor-pointer group relative bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 h-28 grid grid-cols-2 items-center p-4">
                            ...
                            <div className="relative z-10 flex flex-col justify-center items-start">
                                <h3 className="text-sm font-medium text-yellow-700 group-hover:text-white transition-colors duration-300">Ongoing Disputes</h3>
                                <p className="text-lg font-semibold text-yellow-800 group-hover:text-white transition-colors duration-300">2</p>
                            </div>
                        </a>

                        {/* Card: Listed for Sale */}
                        <a onClick={() => handleOpenPopup('sale')} className="cursor-pointer group relative bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 h-28 grid grid-cols-2 items-center p-4">
                            ...
                            <div className="relative z-10 flex flex-col justify-center items-start">
                                <h3 className="text-sm font-medium text-orange-700 group-hover:text-white transition-colors duration-300">Listed for Sale</h3>
                                <p className="text-lg font-semibold text-orange-800 group-hover:text-white transition-colors duration-300">5 plots</p>
                            </div>
                        </a>

                        {activePopup && (
                            <div className="fixed inset-0  flex items-center justify-center bg-black bg-opacity-40 z-50">
                                <div className="bg-white right-0 p-6 rounded-lg shadow-lg w-[90vw] h-[90vh] max-w-3xl w-full">
                                    {renderPopupContent()}
                                    <button
                    ...
                    <div className=" z-0 bg-white shadow-2xl rounded-xl p-4 sm:p-6">
                        <h2 className="font-semibold text-xl text-gray-800 mb-4 flex items-center">
                            <svg className="inline-block w-6 h-6 mr-3 text-indigo-600 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            ...
                            <button className="relative bg-gradient-to-br from-emerald-100 to-emerald-200 hover:from-emerald-200 hover:to-emerald-300 text-emerald-700 font-medium rounded-md py-2 px-3 transition-all duration-300 overflow-hidden transform hover:scale-105 hover:shadow-md">
                                <div className="flex items-center justify-between gap-3">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="text-xs text-gray-500">Transfer Land to another person</p>
                                    </div>
                            ...
                            <button className="relative bg-gradient-to-br from-rose-100 to-rose-200 hover:from-rose-200 hover:to-rose-300 text-rose-700 font-medium rounded-md py-2 px-3 transition-all duration-300 overflow-hidden transform hover:scale-105 hover:shadow-md">
                                <div className="flex items-center justify-between gap-3">
                                    <svg className="w-4 h-4 text-rose-500 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 2h.01m-3-3h6m5 3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <div className="text-left">
                                        <span className="text-sm font-medium text-gray-800">Buy Land</span>
                                        <p className="text-xs text-gray-500">Purchase new plot of land</p>
                                    </div>
                            ...
                            <button className="relative bg-gradient-to-br from-sky-100 to-sky-200 hover:from-sky-200 hover:to-sky-300 text-sky-700 font-medium rounded-md py-2 px-3 transition-all duration-300 overflow-hidden transform hover:scale-105 hover:shadow-md">
                                <div className="flex items-center justify-between gap-3">
                                    <svg className="w-4 h-4 text-sky-500 animate-bounce" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                                    </svg>
                                    <div className="text-left">
                                        <span className="text-sm font-medium text-gray-800">File Dispute</span>
                                        <p className="text-xs text-gray-500">Submit a land dispute complaint</p>
                                    </div>
                ...
                < div className="bg-white shadow-xl rounded-lg p-6 overflow-x-auto" >
                    <div className="flex justify-between items-center w-full">
                        <h2 className="font-semibold text-xl text-gray-800 mb-5 flex items-center">
                            <svg className="inline-block w-6 h-6 mr-3 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4-4m0 0l-4-4m4 4H3M7 16l-4 4m0 0l4 4m-4-4h14" />
                            </svg>
                            Recent Transactions
                        </h2>
                    ...
                    <table className="min-w-full leading-normal mt-3">
                        <thead>
                            <tr className="bg-gray-100 text-gray-700 uppercase text-sm font-semibold">
                                <th className="py-3 px-4 text-left border-b border-gray-200">Transaction ID</th>
                                <th className="py-3 px-4 text-left border-b border-gray-200">Owner Name</th>
                                <th className="py-3 px-4 text-left border-b border-gray-200">Land ID</th>
                                <th className="py-3 px-4 text-left border-b border-gray-200">Date</th>
                                <th className="py-3 px-4 text-center border-b border-gray-200">Status</th>
                                <th className="py-3 px-4 text-center border-b border-gray-200">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            {currentTransactions.map((txn) => (
                                <tr key={txn.id} className="hover:bg-gray-50 transition-colors duration-150"> {/* Added row hover */}
                                    <td className="py-3 px-4 border-b border-gray-200 text-sm">{txn.id}</td>
                                    <td className="py-3 px-4 border-b border-gray-200 text-sm">{txn.owner}</td>
                                    <td className="py-3 px-4 border-b border-gray-200 text-sm">{txn.land}</td>
                                    <td className="py-3 px-4 border-b border-gray-200 text-sm">{txn.date}</td>
