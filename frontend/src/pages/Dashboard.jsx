            ...
            <div className="flex-grow p-4 sm:p-8 pt-16 ">
                ...
                <div className="rounded-lg hidden sm:flex justify-between items-center mb-6 sticky top-0 bg-white z-10 shadow-md p-4">
                    <div className="flex items-center ">
                        ...
                        <h2 className=" col-span-full text-xl font-semibold text-gray-800 ">Dashboard</h2>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-8">
                    <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 relative z-0">
                        ...
                        <a href="#" className="group relative bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 h-28 grid grid-cols-2 items-center p-4">
                            ...
                            <div className="relative z-10 flex justify-center items-center">
                                <div className="rounded-full bg-blue-100 p-2 shadow-md transition-shadow duration-300 group-hover:shadow-lg">
                                    <MdLocationCity className="text-3xl text-blue-600 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0" style={{ pointerEvents: 'none' }} />
                                </div>
                            </div>
                            <div className="relative z-10 flex flex-col justify-center items-start">
                                <p className="text-lg font-semibold text-blue-800 group-hover:text-white transition-colors duration-300">501 plots</p>
                                <h3 className="text-sm font-medium text-blue-700 group-hover:text-white transition-colors duration-300">Registered Land</h3>
                            </div>
                        </a>
                        ...
                        <a href="#" className="group relative bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 h-28 grid grid-cols-2 items-center p-4">
                            ...
                            <div className="relative z-10 flex justify-center items-center">
                                <div className="rounded-full bg-green-100 p-2 shadow-md transition-shadow duration-300 group-hover:shadow-lg">
                                    <MdCheckCircleOutline className="text-3xl text-green-500 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0" style={{ pointerEvents: 'none' }} />
                                </div>
                            </div>
                            <div className="relative z-10 flex flex-col justify-center items-start">
                                <p className="text-lg font-semibold text-green-800 group-hover:text-white transition-colors duration-300">110</p>
                                <h3 className="text-sm font-medium text-green-700 group-hover:text-white transition-colors duration-300">Approved Transactions</h3>
                            </div>
                        </a>
                        ...
                        <a href="#" className="group relative bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 h-28 grid grid-cols-2 items-center p-4">
                            ...
                            <div className="relative z-10 flex justify-center items-center">
                                <div className="rounded-full bg-yellow-100 p-2 shadow-md transition-shadow duration-300 group-hover:shadow-lg">
                                    <MdGavel className="text-3xl text-yellow-500 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0" style={{ pointerEvents: 'none' }} />
                                </div>
                            </div>
                            <div className="relative z-10 flex flex-col justify-center items-start">
                                <p className="text-lg font-semibold text-yellow-800 group-hover:text-white transition-colors duration-300">9</p>
                        ...
                        <a href="#" className="group relative bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 h-28 grid grid-cols-2 items-center p-4">
                            ...
                            <div className="relative z-10 flex justify-center items-center">
                                <div className="rounded-full bg-orange-100 p-2 shadow-md transition-shadow duration-300 group-hover:shadow-lg">
                                    <MdHourglassEmpty className="text-3xl text-orange-500 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0" style={{ pointerEvents: 'none' }} />
                                </div>
                            </div>
                            <div className="relative z-10 flex flex-col justify-center items-start">
                                <p className="text-lg font-semibold text-orange-800 group-hover:text-white transition-colors duration-300">7</p>
                                <h3 className="text-sm font-medium text-orange-700 group-hover:text-white transition-colors duration-300">Pending Transactions</h3>
                            </div>
                        </a>
                    </div>
                    ...
                    <div className="bg-white shadow-2xl rounded-xl p-6 sm:p-8">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            <button className="relative bg-gradient-to-br from-emerald-100 to-emerald-200 hover:from-emerald-200 hover:to-emerald-300 text-emerald-700 font-semibold rounded-md py-3 px-4 transition-all duration-300 overflow-hidden transform hover:scale-105 hover:shadow-md">
                                ...
                                <svg className="inline-block w-5 h-5 mr-3 text-emerald-500 animate-bounce" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <button className="relative bg-gradient-to-br from-rose-100 to-rose-200 hover:from-rose-200 hover:to-rose-300 text-rose-700 font-semibold rounded-md py-3 px-4 transition-all duration-300 overflow-hidden transform hover:scale-105 hover:shadow-md">
                                ...
                                <svg className="inline-block w-5 h-5 mr-3 text-rose-500 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <button className="relative bg-gradient-to-br from-sky-100 to-sky-200 hover:from-sky-200 hover:to-sky-300 text-sky-700 font-semibold rounded-md py-3 px-4 transition-all duration-300 overflow-hidden transform hover:scale-105 hover:shadow-md">
                                ...
                                <svg className="inline-block w-5 h-5 mr-3 text-sky-500 animate-bounce" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="bg-white shadow-xl rounded-lg p-6 overflow-x-auto">
                    <div className="flex justify-between items-center w-full">
                        <h2 className="font-semibold text-xl text-gray-800 mb-5">Recent Activities</h2>
                        <div className="relative">
                            <input
                                type="text"
                                placeholder="Search"
