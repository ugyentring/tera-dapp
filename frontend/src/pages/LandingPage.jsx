...
import FAQImage from "../assets/images/faq.jpg"; // Import your FAQ image
      ...
      >
        <div className="text-center px-4">
          ...
          <div className="mt-6 space-x-3 flex justify-center">
            <button className="px-6 py-3 border-[rgb(14,12,85)] text-white rounded-lg hover:bg-gray-100 border-2 transition-colors duration-300">
              Buy/Sell Land
            </button>
            <button className="px-6 py-3 bg-[rgb(14,12,85)] text-white rounded-lg hover:bg-[rgb(10, 9, 60)] transition-colors duration-300">
              Explore
            </button>
          </div>
        </div>
