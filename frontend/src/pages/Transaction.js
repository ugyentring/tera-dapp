...
const Transaction = () => {
  ...
  const allTransactions = Array.from({ length: 100 }, (_, index) => ({
    ...
    status: index % 2 === 0 ? "Rejected" : "Approved",
      ...
      <div className="flex-grow p-4 sm:p-8 pt-16">
        ...
        <div className="rounded-lg hidden sm:flex justify-between items-center mb-6 sticky top-0 bg-white z-10 shadow-md p-4">
          <div className="flex items-center ">
            ...
            <h2 className=" col-span-full text-xl font-semibold text-gray-800 ">Transactions</h2>
          </div>
  ...
  <table className="w-full mt-3 border-collapse border border-gray-200">
    ...
    <tbody>
      {currentTransactions.map((txn, index) => (
        <tr key={index} className="text-center hover:bg-gray-50 transition-colors duration-150">
  ...
  <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center p-4 sm:p-6 overflow-y-auto">
    <div className="relative bg-white p-4 sm:p-6 rounded-xl shadow-2xl w-full max-w-4xl sm:w-11/12 md:w-10/12 lg:w-2/3 xl:w-1/2 max-h-[95vh] min-w-[60vw] overflow-y-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6">
        ...
        <div className="bg-gray-50 p-4 rounded-lg shadow">
          ...
          <div className="space-y-2 text-sm sm:text-base">
            ...
            <p>
              Status:
              <span
                className={`${selectedTransaction?.status === 'Pending' ? 'text-orange-500' : ''
        ...
        <div className="bg-gray-50 p-4 rounded-lg shadow">
          <h4 className="text-md sm:text-md font-semibold text-[#142854]">Document Attached</h4>
          <div className="text-sm sm:text-base">
            {selectedTransaction?.documentUrl ? (
              <div>
                {[1, 2, 3, 4].map((fileNum) => (
                  <div key={fileNum} className="bg-gray-100 rounded-lg p-2 border mt-2">
                    <a
        ...
        <div className="bg-gray-50 p-4 rounded-lg shadow">
          <div className="pb-3">
            <div className="space-y-2">
              <h4 className="font-semibold text-bold text-[#142854]">Buyer Details</h4>
      ...
      {selectedTransaction?.status === "Rejected" && (
        <div className="bg-red-500 bg-opacity-30 p-4 rounded-lg shadow border border-red-500 mb-4">
          <div className="flex justify-between items-center">
            <h4 className="text-md sm:text-md font-semibold text-red-500">Rejection Details</h4>
          ...
          <div className="bg-red-500 rounded p-2 flex items-center ">
            ...
            <p className="text-white text-sm">Application must be resubmitted with valid information</p>
          </div>
        </div>
      )}
...
<div className="flex justify-center gap-4 mt-6">
  <button
    ...
    className={`bg-green-700 hover:bg-green-800 text-white font-semibold py-2 px-6 rounded-md shadow-md transition duration-200 ease-in-out text-sm ${isApproveDisabled ? "opacity-50 cursor-not-allowed" : "hover:shadow-lg"}`}
  >
    Approve
  </button>
  ...
  <button
    ...
    className={`bg-red-700 hover:bg-red-800 text-white font-semibold py-2 px-6 rounded-md shadow-md transition duration-200 ease-in-out text-sm ${isRejectDisabled ? "opacity-50 cursor-not-allowed" : "hover:shadow-lg"}`}
  >
    Reject
  </button>
</div>
  ...
  >
    ...
    >
      <h2 className="text-lg font-semibold mb-4">
        Confirm {confirmAction.charAt(0).toUpperCase() + confirmAction.slice(1)} Action
      </h2>
      <p className="mb-6">
