...
function BuyLand() {
  ...
  const allTransactions = Array.from({ length: 100 }, (_, index) => ({
    ...
    documentUrl: "asdf",
    thramNo: "2A-234",
    imageUrl: `https://via.placeholder.com/300/${Math.floor(
      Math.random() * 16777215
    ).toString(16)}/FFFFFF?Text=Land+Image`,
  }));
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p>
                    ...
                    {selectedTransaction.land}
                  </p>
                  <p>
                    <span className="font-semibold">Location:</span>{" "}
                    {selectedTransaction.landInfo.location}
                  </p>
                  <p>
                    <span className="font-semibold">Size:</span>{" "}
                    {selectedTransaction.landInfo.size}
                  </p>
                </div>
            ...
            <div className="relative bg-white p-6 rounded-xl shadow-2xl w-full max-w-3xl max-h-[95vh] min-w-[60vw] overflow-y-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  />
                  <p>
                    <strong>Land ID:</strong> {selectedTransaction.land}
                  </p>
                ...
                <div className="flex flex-col flex-1 p-4">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between text-gray-600 text-sm gap-4 mb-4">
                    <div>
                      ...
                      <p>
                        <strong>Location:</strong>{" "}
                        {transaction.landInfo.location}
                      </p>
                    </div>
                    <div className="sm:text-right">
                      <p>
                        <strong>Size:</strong> {transaction.landInfo.size}
                      </p>
                      <p>
                        <strong>Thram No:</strong> {transaction.thramNo}
                      </p>
                    </div>
                  </div>
