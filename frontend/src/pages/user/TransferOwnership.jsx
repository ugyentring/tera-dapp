...
function TransferOwnership() {
  ...
  const allTransactions = Array.from({ length: 100 }, (_, index) => ({
    ...
    ).toString(16)}/FFFFFF?Text=Land+Image`, // Placeholder image URL
  }));
      ...
      <div className="flex-grow p-4 sm:p-8 pt-16">
        ...
        <div className="rounded-lg hidden sm:flex justify-between items-center mb-6 sticky top-0 bg-white z-10 shadow-md p-4">
          <div className="flex items-center gap-4 ">
            ...
            <h1 className="font-semibold text-gray-800 ml-5">
              Transfer Ownership
            </h1>
          </div>
        ...
        <div className="bg-gray-50 p-6 sm:p-10">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label
                  htmlFor="ownershipProofDocument"
                  className="block text-gray-700 text-sm font-medium mb-1"
                >
                  Ownership Proof
                </label>
                <input
                  ...
                  onChange={(e) =>
                    handleFileChange(e, setOwnershipProofDocument)
                  }
                />
              </div>
              <div>
